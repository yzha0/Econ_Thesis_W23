...
% KGC: This intro sentence may not be fully necessary in all this detail, but I think this version is snappier: "Social capital can also reduce information frictions and search costs for workers and firms, helping the labor market function more efficiently." 
...
% This should be the last paragraph You could even use numbering here like "Section 2 gives background... Section 3 describes the data, etc."
...
% KGC: Add a cite for this sentence. 
...
% KGC: In methods/data I'd note that oyu use many time periods of data, but cross-sectional county-level social capital measures. Otherwise, this is a curveball that you can do time FEs. 
...
% KGC: End on a positive note possibly? New direcetions? What would be possible with more time? Not just nitpicks of better data, but how wo=il
